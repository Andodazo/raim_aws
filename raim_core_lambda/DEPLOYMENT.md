...
| `MantleModelId` | `DUMMY_GEMMA4_MODEL_ID_REPLACE_ME` | us-east-1で利用するGemma 4 model ID |
...
| `OPENAI_BASE_URL` | `https://bedrock-mantle.us-east-1.api.aws/openai/v1` | Gemma 4を呼び出すMantle endpoint |
